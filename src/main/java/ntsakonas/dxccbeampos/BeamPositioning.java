...
public class BeamPositioning {
    ...
    public static Function<EntityInfo, Function<EntityInfo, Function<EntityInfo, PositionInfo>>> positionForPrefixes =
            myEntity -> dxEntity -> targetEntity -> {
                ...
                return new PositionInfo(dxEntity.countryName, targetEntity.countryName, bearingToTarget, distanceToTarget, bearingToMyLocation, distanceToMyLocation);
            };
